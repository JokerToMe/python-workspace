...
def set_table():
    ...
    # js请求参数里的type，第1-4个表的前缀是‘YJBB20_',后三个表示‘CWBB_'
    ...
    def write_header(data,category):
        with open('{}.csv'.format(category),'a',encoding='utf-8_sig',) as f:
